    ...
    <div className="lc-waitlist-page">
      ...
      <style>{`
        ...
        @media (max-width: 480px) {
          .lc-hero { padding: 4.5rem 1.25rem 4.5rem; margin-top: 92px; }
      ...
      <header className="lc-header">
        <div className="lc-header-inner">
          <Link to="/" className="lc-logo"><img src="/curae-logo.png" alt="Curae" style={{ height: '64px', width: 'auto' }} /></Link>
      ...
      <footer className="lc-footer">
        <Link to="/" className="lc-footer-logo"><img src="/curae-logo.png" alt="Curae" style={{ height: '64px', width: 'auto' }} /></Link>
