...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  tester_creator_login: {
    ...
    html: `<p>Hi there,</p>
<p>Great news: your creator tester access to Curae is now open.</p>
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  tester_consumer_login: {
    ...
    html: `<p>Hi there,</p>
<p>Great news: your tester access to Curae is now open.</p>
...
<p>You have full access to Curae. Explore everything we've built and everything that's coming. Your feedback shapes what we build next.</p>
...
<p>You have full access to Curae's creator tools: your dashboard, product listings, analytics, and everything we're building for creators. Your feedback shapes what we build next.</p>
<p>Thanks for being here from the start.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>You have full access to Curae's creator tools: your dashboard, product listings, analytics, and everything we're building. Plus, you'll see experimental features first and help us refine them.</p>
...
<p>Your feedback as a tester will directly shape how we build Curae. When you're ready to sign in, just return to the waitlist page and request a secure magic link. We'll send it to your email instantly.</p>
<p>Thank you for believing in what we're building, and for helping us build it.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>You have full access to Curae. Explore everything we've built and everything that's coming. Plus, you'll see experimental features first and help us refine them.</p>
<p>Your feedback shapes what we build next. Thanks for being here from the start.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  consumer_wave_1_login: {
    ...
    html: `<p>Hi there,</p>
<p>You just signed in using your secure magic link. This confirms your email and gives you access to your account.</p>
<p>As a Wave 1 member, you're first in line. When we open access, you'll unlock the foundation of Curae: core discovery, personalized feeds, and the tools everything else builds on.</p>
<p>We're almost ready. Thanks for your patience.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  consumer_wave_2_login: {
    ...
    html: `<p>Hi there,</p>
<p>You just signed in using your secure magic link. This confirms your email and gives you access to your account.</p>
<p>As a Wave 2 member, you'll unlock engagement features when your wave opens: community interactions, saved collections, and the tools that bring Curae to life.</p>
