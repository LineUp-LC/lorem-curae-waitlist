...
<p>You can now explore Curae and test new features before anyone else. Your feedback will help us build something great.</p>
...
<p>You now have access to expanded marketplace tools: product analytics, promotional features, and new ways to grow your audience on Curae.</p>
<p><strong><a href="{{MAGIC_LINK}}">Click here to access your creator dashboard</a></strong></p>
...
<p>As a Wave 1 member, you're among the first to access the foundation of Curae: core discovery tools, personalized feeds, and the essentials we're building everything else on top of.</p>
<p><strong><a href="{{MAGIC_LINK}}">Click here to explore Curae</a></strong></p>
...
<p>You now have access to our engagement features: community interactions, saved collections, and tools that make Curae feel like more than just browsing.</p>
<p><strong><a href="{{MAGIC_LINK}}">Click here to explore Curae</a></strong></p>
<p>Thanks for being part of this journey.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>You now have access to our expansion features: new content categories, broader marketplace offerings, and a more complete Curae experience.</p>
<p><strong><a href="{{MAGIC_LINK}}">Click here to explore Curae</a></strong></p>
<p>Thanks for being part of this journey.</p>
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  },
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  role_upgraded_generic: {
    subject: "Your Curae access has been upgraded",
    html: `<p>Hi there,</p>
...
<p>Best,<br/>Ethan Jones<br/>Founder, Curae</p>`,
  ...
  role_downgraded_generic: {
    subject: "Your Curae access has changed",
    html: `<p>Hi there,</p>
<p>We wanted to let you know that your Curae access level has changed.</p>
