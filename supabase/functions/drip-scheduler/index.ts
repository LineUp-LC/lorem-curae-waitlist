...
<p>Point your camera at any product. We identify it, then score every ingredient against your skin profile. You get back a safety rating, an ingredient-by-ingredient breakdown, compatible products, and where to buy.</p>
...
<p><strong>2. Scores every ingredient against your skin profile.</strong> Each one is marked safe, caution, or avoid — with the specific reason. Fragrance triggering your eczema? Retinol conflicting with the acid you're already using? You see it.</p>
...
<p><strong>Curae AI, trained on your skin profile and routine.</strong> Ask it whether a new product fits alongside what you already use. It answers in context — not generic advice.</p>
